        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-8 col-sm-6">
                    <div class="box-login">
                        {{ Form::open(array('url' => 'admin/excursion-save','class' => 'form-horizontal','files' =>true)) }}
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('excursion_text', '', $attributes = ['class' => 'form-control','required' => 'required', 'rows' => 4  ]) }}
