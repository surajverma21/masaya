                        ...
                        <div class="box-login">
                            <div class="panel-outer">
                                <div class="panel-inner">
                                    <h4 class="panel-title"> Update <span class="text-bold">Activity</span></h4>
                                ...
                                {{ Form::open(array('url' => 'admin/update_activity','class' => 'form-horizontal','files' =>true)) }}
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            {{ Form::text('name', $activity->name, $attributes = ['class' => 'form-control', 'placeholder' => 'Activity Name','required' => 'required']) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            {{ Form::text('description', $activity->description, $attributes = ['class' => 'form-control', 'placeholder' => 'A short text about activity','required' => 'required']) }}
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        {{ Form::label('image','Image', $attributes = ['class' => 'col-sm-3 control-label']) }}

                                        <div class="col-sm-5">
                                            {{ Form::file('activity_image', '', $attributes = ['class' => 'form-control']) }}
                                        </div>


                                        <div class="col-sm-4">@if($activity->image)<img style="max-width:100%; width:100%;" src="{{URL::to('/')}}/../uploads/activities/{{$activity->image}}" alt=""/>@endif</div>
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('day','Activity day', $attributes = ['class' => 'col-sm-3 control-label']) }}
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-9 paddinglft " >
                                            ...
                                            {{ Form::text('date-time-range', $activity->start_time.'-'.$activity->end_time, $attributes = ['class' => 'form-control date-time-range','required' => 'required']) }}
                                        </div>
                                    </div>
