...
>>>>>>> 2e4e442b7e77eeb453dffb363910888e40bd16e6
            </div>
</div>
</div>
</div>

<div class="activtity_arrow-wrap">
    <a class="carousel-control left" href="#myCarousel" data-slide="prev">
        <img class="imgfull-width" src="../assets/front/images/act_banner_Arrow.png" alt="" />
    </a>
    <a class="carousel-control right" href="#myCarousel" data-slide="next">
       <img class="imgfull-width" src="../assets/front/images/act_banner_Arrow_rgt.png" alt="" />
    </a>
</div>
...
<div class="act_cul_mobile">
    <div class="ul_acc" id="accordion">
        <div class="ulrow"><a href="#">Lundi<span><img src="../assets/front/images/select_cul_drop.png" alt="" /></span></a></div>
        <div class="row margin_none">
                     ...
                     <div class="col-xs-12 padding_none">
                         <img class="imgfull-width" alt="" src="images/act_slide_img.png">
                     </div>
                     <div class="col-xs-12 padding_none">
                           <div class="slide_main_con">
                              <h1>Juegos criollos</h1>
        ...
        <div class="ulrow"><a href="#">Mardi<span><img src="../assets/front/images/select_cul_drop.png" alt="" /></span></a></div>
         <div class="row margin_none">
                     <div class="col-xs-12 padding_none">
                          <div class="slide_main_con">
                              <h1>Juegos criollos</h1>
        ...
        <div class="ulrow"><a href="#">Mercredi<span><img src="../assets/front/images/select_cul_drop.png" alt="" /></span></a></div>
        <div class="row margin_none">
                     <div class="col-xs-12 padding_none">
                          <div class="slide_main_con">
                              <h1>Juegos criollos</h1>
        ...
        <div class="ulrow"><a href="#">Jeudi <span><img src="../assets/front/images/select_cul_drop.png" alt="" /></span></a></div>
        <div class="row margin_none">
                     <div class="col-xs-12 padding_none">
                          <div class="slide_main_con">
                              <h1>Juegos criollos</h1>
        ...
        <div class="ulrow"><a href="#">Vendredi <span><img src="../assets/front/images/select_cul_drop.png" alt="" /></span></a></div>
        <div class="row margin_none">
                     <div class="col-xs-12 padding_none">
                          <div class="slide_main_con">
                              <h1>Juegos criollos</h1>
        ...
        <div class="ulrow"><a href="#">Samedi <span><img src="../assets/front/images/select_cul_drop.png" alt="" /></span></a></div>
        <div class="row margin_none">
                     <div class="col-xs-12 padding_none">
                          <div class="slide_main_con">
                              <h1>Juegos criollos</h1>
        ...
        <div class="ulrow"><a href="#">Dimanche <span><img src="../assets/front/images/select_cul_drop.png" alt="" /></span></a></div>
        <div class="row margin_none">
                     <div class="col-xs-12 padding_none">
                          <div class="slide_main_con">
                              <h1>Juegos criollos</h1>
...
<div class="contant_cities_top text-center con-mobile_visible" id="tab-bottom-container">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-9">
                        <h1 class="foo_ter_tit">Santa Marta</h1>
                        <span class="pull-right foo_scroll_top">
                           <a class="foo_carret caret dropdown-toggle" data-toggle="dropdown" href="#"></a>
                    ...
                    <div class="col-md-1 col-sm-1 col-xs-1 text-center popup_close2">
        ...
        <div class="footer_head">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-1 col-sm-1 popup_close2 col-xs-1 text-center">
                        <a class="fo_close" href="javascript:void(0)"><img src="../assets/front/images/footer_close.png" alt="" /></a>
                    </div>
                </div>
        ...
        <div class="footer_head">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-9">
                        <h1 class="foo_ter_tit">Contactez-nous !</h1>
                        <span class="pull-right foo_scroll_top">
                           <a class="foo_carret caret dropdown-toggle" data-toggle="dropdown" href="#"></a>
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="#">Santa Marta</a></li>
    ...
    <li  class="padding_none contactclose">
        <a href="#bottom-tab1">
            <div class="socail12">
                ...
                <h2 class="hidden_mobile">Bogota</h2>
            </div>
        </a>
    </li>
    <li class="padding_none contactclose">
        <a href="#bottom-tab2">
            <div class="socail12">
                <img class="rev_hide" src="../assets/front/images/info.png" alt="" />
                <img class="rev_show" src="../assets/front/images/info_Active.png" alt="" />
...
<!-- contact cities desktop tablet -->
<div class="contant_cities_top text-center mobile_hidden" id="tab-bottom-container">
<div class="panel-container">
<div id="bottom-tab1">
    <!-- #foo1 Bogota section start -->
    <div class="foo1_content">
