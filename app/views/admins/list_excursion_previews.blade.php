            ...
            <div class="toolbar row">
                <div class="col-sm-6 hidden-xs">
                    <div class="page-header">
                        @if(count($excursion_hostel))
                        <h1>{{ $excursion_hostel[0]->hostel->name or ''}}</h1>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover" id="sample-table-2">
                                ...
                                @foreach ($excursion_hostel as $excursion_hostel_one)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $excursion_hostel_one->excursion_text }} </td>


                                    <td>
                                        {{ $excursion_hostel_one->language->name }}
                                    </td>
