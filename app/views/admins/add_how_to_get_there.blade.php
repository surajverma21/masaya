        ...
        <div class="container">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="toolbar-tools pull-right">
                        ...
                        <ul class="nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a href="{{ URL::to('/') }}/admin/how-to-get-there-add">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-8 col-sm-6">
                    <div class="box-login">
                        {{ Form::open(array('url' => 'admin/how-to-get-there-save','class' => 'form-horizontal','files' =>true)) }}
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    {{Form::text('title','',$attributes = ['required' => 'required','style'=>'width: 300px'])}}
